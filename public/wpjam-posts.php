...
function wpjam_get_post_type_actions($post_type){
	return WPJAM_PostType::get_actions($post_type);
}
...
function wpjam_get_parent_terms($term){
	return WPJAM_Taxonomy::get_parents($term);
}

function wpjam_get_taxonomy_supports($taxonomy){
	return WPJAM_Taxonomy::get_supports($taxonomy);
}

function wpjam_get_taxonomy_levels($taxonomy){
	return WPJAM_Taxonomy::get_levels($taxonomy);
}
