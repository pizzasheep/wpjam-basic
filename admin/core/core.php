...
add_action('current_screen', function($current_screen){
	...
	if($pagenow == 'post.php' || $pagenow == 'post-new.php'){
		...
		include WPJAM_BASIC_PLUGIN_DIR.'admin/core/term-base.php';
...
add_action('wp_loaded', function(){
	if(wp_doing_ajax()){
		...
		if($ajax_action == 'query_posts'){
			$args	= $_POST;
			unset($args['action']);
			$_query	= new WP_Query($args);
			wpjam_send_json($_query->posts);
		}elseif($ajax_action == 'inline-save' || $ajax_action == 'post-list-table-action'){
			...
			include WPJAM_BASIC_PLUGIN_DIR.'admin/core/post-list.php';
		}elseif($ajax_action == 'add-tag' || $ajax_action == 'inline-save-tax'){
